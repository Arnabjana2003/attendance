...
function App() {
  ...
  const getDetails = () => {
    ...
    services
      .getStudents(
        String(import.meta.env.VITE_APPWRITE_FIRSTYEAR_STUDENTS_COLLECTION_ID)
      )
      .then((data) => {
    ...
    services
      .getStudents(
        String(import.meta.env.VITE_APPWRITE_SECONDYEAR_STUDENTS_COLLECTION_ID)
      )
      .then((data) => {
    ...
    services
      .getStudents(
        String(import.meta.env.VITE_APPWRITE_THIRDYEAR_STUDENTS_COLLECTION_ID)
      )
      .then((data) => {
    ...
    services
      .getStudents(
        String(import.meta.env.VITE_APPWRITE_FOURTHYEAR_STUDENTS_COLLECTION_ID)
      )
      .then((data) => {
  ...
  return (
    <div className=" w-full min-h-screen bg-gradient-to-tl to-blue-900 from-blue-400 text-white">
      {dataUpdate ? (
        ...
        <div className=" w-full flex justify-center fixed top-20">
